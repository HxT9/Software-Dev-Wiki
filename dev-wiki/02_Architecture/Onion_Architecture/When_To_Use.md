...
```mermaid
flowchart TD
  Q[Sto valutando Onion Architecture?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Onion Architecture]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Onion Architecture è la scelta giusta.
-
