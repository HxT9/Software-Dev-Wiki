...
```mermaid
flowchart TD
  Q[Sto valutando Modular Monolith?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Modular Monolith]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Modular Monolith è la scelta giusta.
-
