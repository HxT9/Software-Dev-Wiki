...
```mermaid
flowchart TD
  Q[Sto valutando Event Streaming?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Event Streaming]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Event Streaming è la scelta giusta.
-
