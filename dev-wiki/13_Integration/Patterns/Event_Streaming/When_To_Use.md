...
```mermaid
flowchart TD
  Q[Considering Event Streaming?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Event Streaming]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Event Streaming is the right call.
-
