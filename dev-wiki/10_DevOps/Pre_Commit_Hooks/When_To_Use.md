...
```mermaid
flowchart TD
  Q[Considering Pre Commit Hooks?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Pre Commit Hooks]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Pre Commit Hooks is the right call.
-
