...
```mermaid
flowchart TD
  Q[Sto valutando Pre Commit Hooks?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Pre Commit Hooks]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Pre Commit Hooks è la scelta giusta.
-
