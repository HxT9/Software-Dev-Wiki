...
```mermaid
flowchart TD
  Q[Considering Schema Migrations?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Schema Migrations]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Schema Migrations is the right call.
-
