...
```mermaid
flowchart TD
  Q[Considering Fault Injection?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Fault Injection]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Fault Injection is the right call.
-
