...
```mermaid
flowchart TD
  Q[Considering Data Structures?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Data Structures]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Data Structures is the right call.
-
