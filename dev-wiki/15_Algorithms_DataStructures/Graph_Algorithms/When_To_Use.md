...
```mermaid
flowchart TD
  Q[Considering Graph Algorithms?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Graph Algorithms]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Graph Algorithms is the right call.
-
