...
```mermaid
flowchart TD
  Q[Sto valutando Dynamic Programming?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Dynamic Programming]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Dynamic Programming è la scelta giusta.
-
