...
```mermaid
flowchart TD
  Q[Sto valutando Divide and Conquer?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Divide and Conquer]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Divide and Conquer è la scelta giusta.
-
