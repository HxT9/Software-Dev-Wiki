...
```mermaid
flowchart TD
  Q[Considering Premature Optimization?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Premature Optimization]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Premature Optimization is the right call.
-
