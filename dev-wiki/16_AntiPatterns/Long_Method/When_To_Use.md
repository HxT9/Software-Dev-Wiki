...
```mermaid
flowchart TD
  Q[Sto valutando Long Method?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Long Method]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Long Method è la scelta giusta.
-
