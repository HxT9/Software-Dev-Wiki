...
```mermaid
flowchart TD
  Q[Sto valutando Separation of Concerns?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Separation of Concerns]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Separation of Concerns è la scelta giusta.
-
