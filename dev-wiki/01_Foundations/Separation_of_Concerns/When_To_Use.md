...
```mermaid
flowchart TD
  Q[Considering Separation of Concerns?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Separation of Concerns]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Separation of Concerns is the right call.
-
