...
```mermaid
flowchart TD
  Q[Sto valutando Error Tracking?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Error Tracking]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Error Tracking è la scelta giusta.
-
