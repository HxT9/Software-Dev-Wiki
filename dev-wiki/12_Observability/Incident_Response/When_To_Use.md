...
```mermaid
flowchart TD
  Q[Sto valutando Incident Response?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Incident Response]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Incident Response è la scelta giusta.
-
