...
```mermaid
flowchart TD
  Q[Considering Documentation as Code?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Documentation as Code]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Documentation as Code is the right call.
-
