...
```mermaid
flowchart TD
  Q[Sto valutando Model Evaluation?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Model Evaluation]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Model Evaluation è la scelta giusta.
-
