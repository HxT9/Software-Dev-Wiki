...
```mermaid
flowchart TD
  Q[Sto valutando Agent Patterns?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Agent Patterns]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Agent Patterns è la scelta giusta.
-
