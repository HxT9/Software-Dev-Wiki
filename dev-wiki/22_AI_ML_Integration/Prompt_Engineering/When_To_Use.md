...
```mermaid
flowchart TD
  Q[Sto valutando Prompt Engineering?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Prompt Engineering]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Prompt Engineering è la scelta giusta.
-
