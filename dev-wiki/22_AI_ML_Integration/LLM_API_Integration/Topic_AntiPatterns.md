# Topic Anti-Patterns - LLM API Integration

> Anti-pattern *specifici di LLM API Integration*.
...
## Smells correlati
Smell che spesso preludono a un uso scorretto di LLM API Integration.
-
