...
```mermaid
flowchart TD
  Q[Sto valutando Leader Election?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Leader Election]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Leader Election è la scelta giusta.
-
