...
```mermaid
flowchart TD
  Q[Considering Leader Election?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Leader Election]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Leader Election is the right call.
-
