...
```mermaid
flowchart TD
  Q[Considering Service Discovery?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Service Discovery]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Service Discovery is the right call.
-
