...
```mermaid
flowchart TD
  Q[Sto valutando Retry Patterns?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Retry Patterns]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Retry Patterns è la scelta giusta.
-
