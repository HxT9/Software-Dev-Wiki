...
```mermaid
flowchart TD
  Q[Considering Gossip Protocols?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Gossip Protocols]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Gossip Protocols is the right call.
-
