...
```mermaid
flowchart TD
  Q[Considering Distributed Locks?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Distributed Locks]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Distributed Locks is the right call.
-
