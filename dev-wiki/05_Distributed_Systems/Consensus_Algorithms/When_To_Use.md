...
```mermaid
flowchart TD
  Q[Sto valutando Consensus Algorithms?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Consensus Algorithms]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Consensus Algorithms è la scelta giusta.
-
