...
```mermaid
flowchart TD
  Q[Sto valutando Standard Library?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Standard Library]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Standard Library è la scelta giusta.
-
