...
```mermaid
flowchart TD
  Q[Sto valutando Type System?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Type System]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Type System è la scelta giusta.
-
