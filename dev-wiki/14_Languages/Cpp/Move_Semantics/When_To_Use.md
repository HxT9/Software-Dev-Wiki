...
```mermaid
flowchart TD
  Q[Considering Move Semantics?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Move Semantics]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Move Semantics is the right call.
-
