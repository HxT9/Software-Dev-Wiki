...
```mermaid
flowchart TD
  Q[Considering Source Generators?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Source Generators]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Source Generators is the right call.
-
