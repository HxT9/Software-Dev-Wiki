...
```mermaid
flowchart TD
  Q[Sto valutando Bottleneck Analysis?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Bottleneck Analysis]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Bottleneck Analysis è la scelta giusta.
-
