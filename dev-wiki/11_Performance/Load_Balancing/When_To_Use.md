...
```mermaid
flowchart TD
  Q[Considering Load Balancing?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Load Balancing]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Load Balancing is the right call.
-
