...
```mermaid
flowchart TD
  Q[Considering Snapshot Testing?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Snapshot Testing]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Snapshot Testing is the right call.
-
