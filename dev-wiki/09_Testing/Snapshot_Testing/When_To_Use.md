...
```mermaid
flowchart TD
  Q[Sto valutando Snapshot Testing?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Snapshot Testing]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Snapshot Testing è la scelta giusta.
-
