...
```mermaid
flowchart TD
  Q[Sto valutando Performance Testing?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Performance Testing]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Performance Testing è la scelta giusta.
-
