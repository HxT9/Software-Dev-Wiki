...
```mermaid
flowchart TD
  Q[Sto valutando Template Method?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Template Method]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Template Method è la scelta giusta.
-
