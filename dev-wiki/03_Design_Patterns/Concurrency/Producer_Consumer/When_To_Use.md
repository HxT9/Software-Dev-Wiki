...
```mermaid
flowchart TD
  Q[Sto valutando Producer Consumer?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Producer Consumer]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Producer Consumer è la scelta giusta.
-
