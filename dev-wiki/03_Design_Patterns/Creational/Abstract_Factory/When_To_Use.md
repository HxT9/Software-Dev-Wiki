...
```mermaid
flowchart TD
  Q[Considering Abstract Factory?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Abstract Factory]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Abstract Factory is the right call.
-
