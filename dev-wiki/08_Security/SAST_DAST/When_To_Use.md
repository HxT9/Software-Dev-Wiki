...
```mermaid
flowchart TD
  Q[Sto valutando SAST DAST?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera SAST DAST]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè SAST DAST è la scelta giusta.
-
