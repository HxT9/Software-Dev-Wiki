...
```mermaid
flowchart TD
  Q[Considering Container Security?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Container Security]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Container Security is the right call.
-
