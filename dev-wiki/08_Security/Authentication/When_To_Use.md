...
```mermaid
flowchart TD
  Q[Considering Authentication?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Authentication]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Authentication is the right call.
-
