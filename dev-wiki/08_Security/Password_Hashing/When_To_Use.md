...
```mermaid
flowchart TD
  Q[Sto valutando Password Hashing?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Password Hashing]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Password Hashing è la scelta giusta.
-
