...
```mermaid
flowchart TD
  Q[Sto valutando Anti Corruption Layer?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Anti Corruption Layer]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Anti Corruption Layer è la scelta giusta.
-
