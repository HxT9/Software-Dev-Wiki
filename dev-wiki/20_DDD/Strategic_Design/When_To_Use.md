...
```mermaid
flowchart TD
  Q[Considering Strategic Design?] --> Q1[Do I have problem X?]
  Q1 -->|Yes| OK[Consider Strategic Design]
  Q1 -->|No| NO[Probably not needed]
```

## Real Scenarios
- Scenario 1: context, constraints, why Strategic Design is the right call.
-
