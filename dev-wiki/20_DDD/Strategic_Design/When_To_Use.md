...
```mermaid
flowchart TD
  Q[Sto valutando Strategic Design?] --> Q1[Ho il problema X?]
  Q1 -->|Si| OK[Considera Strategic Design]
  Q1 -->|No| NO[Probabilmente non serve]
```

## Real Scenarios
- Scenario 1: contesto, vincoli, perchè Strategic Design è la scelta giusta.
-
